...
local CODES = {
	...
	untracked = 5,
	modified = 4,
	staged = 3.5, -- staged modification (新增)
	added = 3,
	deleted = 2,
	updated = 1,
	unknown = 0,
...
-- 匹配规则按优先级排序 - 使用精确的pattern匹配第1和第2位
local PATTERNS = {
	...
	{ "MM", CODES.modified },     -- MM = staged + unstaged (显示为unstaged)
...
local function setup(st, opts)
	...
	local styles = {
		...
		[CODES.staged] = t.staged and ui.Style(t.staged) or ui.Style():fg("cyan"),
